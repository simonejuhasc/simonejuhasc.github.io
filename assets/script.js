    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            if (isValid) {
                ...
                const whatsappMessage = `Olá! Meu nome é ${name.value}. ${message ? message.value : 'Gostaria de agendar um horário.'}`;
                const whatsappUrl = `https://wa.me/5544999999999?text=${encodeURIComponent(whatsappMessage)}`;
